  ...
  return (
    <html lang='en' className='!scroll-smooth'>
      ...
      >
        ...
        <div className='bg-[#658C58] absolute top-[-1rem] -z-10 left-[-15rem] h-[31.25rem] w-[50rem] rounded-full blur-[10rem] sm:w-[68.75rem] md:left-[-33rem] lg:left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem] dark:bg-[#31694E] opacity-70'></div>
